...
import pytest
from source_alberta_re.source import AlbertaReStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AlbertaReStream, "path", "v0/example_endpoint")
    mocker.patch.object(AlbertaReStream, "primary_key", "test_primary_key")
    mocker.patch.object(AlbertaReStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = AlbertaReStream()
